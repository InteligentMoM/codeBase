...
ap.add_argument("-i", "--input_text_file_path", required=True, help="(Input) Please Enter Transcript csv file path for keyword highlight...")
ap.add_argument("-o", "--output_text_file_path", required=True, help="(Output) Please Enter Transcript Text file path for keyword highlight...")
...
dataset = pd.read_csv(args["input_text_file_path"])
...
dataset['high_lighted']  = dataset['Transcript'].apply(lambda x : highlight(str(x)))
...
dataset.to_csv(args["output_text_file_path"])
